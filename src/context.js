...
export default Morearty.createContext({
  initialState: {
    ...
    market: [
      ...
      { type: 'order', party: 1, offering: { stock: 1 }, asking: { money: 60 }, quantity: 100, date: step1 },
      ...
      { type: 'order', party: 4, offering: { money: 40 }, asking: { stock: 2 }, quantity: 200, date: step3 },
      ...
      { type: 'arbitrage', trades: [
        { type: 'trade', party: 3, counterparty: null, receiving: [{ stock: 1, quantity: 200 }], sending: [{ money: 15000 }]},
        { type: 'trade', party: 4, counterparty: null, receiving: [{ stock: 2, quantity: 200 }], sending: [{ money: 8000 }]},
      ], date: step3 }
